            ...
            <div className="group aspect-[100/127] border rounded-lg flex flex-col justify-between overflow-hidden ">
                <div className="relative flex-1 bg-amber-100">
                    ...
                    <Actions
                        ...
                        side="right"
                    >
                        <button className="absolute top-1 right-1 oapcity-0 group-hover:opacity-100 transition-opacity px-3 py-2 outline-none">
                            <MoreHorizontal
                                className="text-blue opacity-75 hover:opacity-100 transition-opacity"
                            />
